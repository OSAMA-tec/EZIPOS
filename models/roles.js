...
const rolesSchema = new mongoose.Schema({
  ...
  viewAllVariations: {type: Boolean},
  createVariation: {type: Boolean},
  updateVariation: {type: Boolean},
  deleteVariation: {type: Boolean},
  getVariationById: {type: Boolean},
  getAllWarranties: {type: Boolean},
  createWarranty: {type: Boolean},
  updateWarranty: {type: Boolean},
  deleteWarranty: {type: Boolean},
  getWarrantyById: {type: Boolean},
});
